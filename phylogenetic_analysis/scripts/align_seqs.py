...
def filter_seqs(aligned_path=None, min_length=None):
    ...
    # removes odd characters from sequence names
...
def run():
    ...
    if args.align == True:
        ...
        degapped_seqs_path = args.sequences
    # quality filtering
